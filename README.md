...
Steps:
1. Create epense namespace
2. install EBS drivers
3. create EBS SC
4. Give EKS nodes permissions
5. create PVC, crate statefulset

STATEFULLSET:
-----------
1.headless service & 2.PVC attache apart form this all same as deployment.
